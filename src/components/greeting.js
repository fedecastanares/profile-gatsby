    ...
    return ( 
        ...
        <div className={classes.root}>
            <Container className={classes.container} maxWidth='sm'>
                ...
                <Typography className={classes.about} variant="body1" gutterBottom><br/><span style={{fontStyle: 'italic', fontWeight: 400}}>Disfruta del camino.</span> <br/>Tambien disfruto al aire libre y  juego a videojuegos, soy jugador de clubes pro y COD.</Typography>
            </Container>
        </div>
        </>
     );
